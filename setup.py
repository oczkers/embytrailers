...
setup(
    name=__title__,
    version=__version__,
    description='%s is a simple script downloading missing trailers in Emby database.' % __title__,
    ...
    platforms='any',
    keywords='%s emby trailer trailers' % __title__,
    packages=packages,
